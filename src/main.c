...
/*   Updated: 2024/06/22 19:50:31 by pnguyen-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	mlx_produce(t_cub3d *cub3d)
{
	...
	if (!cub3d->mlx.ptr)
		return (1);
	cub3d->mlx.win = mlx_new_window(cub3d->mlx.ptr, SCREEN_WIDTH, SCREEN_HEIGHT, "Cub3D");
	if (!cub3d->mlx.win)
	{
	...
	cub3d->mlx.buffer.ptr = mlx_new_image(cub3d->mlx.ptr, SCREEN_WIDTH, SCREEN_HEIGHT);
