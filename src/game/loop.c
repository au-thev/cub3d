...
/*   Updated: 2024/03/21 18:58:02 by antheven         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	loop(void *param)
{
	...
	while (keycode-- > 0)
	{
		...
		{
			if (game->display.level.map[(int)game->player.location.y][(int)(game->player.location.x + -sin(deg_to_rad(game->player.direction)))] == '0')
				game->player.location.x += -sin(deg_to_rad(game->player.direction)) / 40.0;
			if (game->display.level.map[(int)(game->player.location.y + cos(deg_to_rad(game->player.direction)))][(int)game->player.location.x] == '0')
